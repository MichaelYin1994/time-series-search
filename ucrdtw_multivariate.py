...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 23 15:08:48 2020
...
def preprocessing_ts(ts=None,
    ...
    return np.array([min_ind, max_ind, min_val, max_val]), ts_norm, keogh_lb, keogh_ub, ts_ind_ordered
...
if __name__ == "__main__":
    ...
    for data, data_label, name in zip(raw_dataset, raw_label, dataset_names):
        ...
        for i in range(len(data)):
            data_compact.append(preprocessing_ts(data[i], is_norm_ts=NORM_TS,
